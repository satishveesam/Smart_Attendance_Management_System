...
const EmployeeDashboard = () => {
  ...
  const primaryActions = [
    ...
    { title: 'Late Entries', icon: <LateIcon sx={{ fontSize: { xs: 16, sm: 22 }, color: '#ef4444' }} />, action: 'late-entries', bg: '#fef2f2' },
    { title: 'Extra Shifts', icon: <OvertimeIcon sx={{ fontSize: { xs: 16, sm: 22 }, color: '#8b5cf6' }} />, action: 'extra-shifts', bg: '#f3e8ff' },
    { title: 'Roster Schedule', icon: <RosterIcon sx={{ fontSize: { xs: 16, sm: 22 }, color: '#3b82f6' }} />, bg: '#e0f2fe' },
